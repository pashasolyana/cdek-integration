...
export class CalcTariffListRequestDto {
  ...
  @ApiPropertyOptional({
    description: 'Тип заказа: 1 — ИМ, 2 — Доставка',
    default: 1,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Доп.типы заказа (см. документацию)',
    type: [Number],
  })
  @IsOptional()
  @IsArray()
...
export class CalcTariffItemDto {
  ...
  @ApiProperty({
    type: () => Object,
    example: { min: '2022-02-02', max: '2022-02-04' },
  })
