...
export class SyncDeliveryPointsQueryDto {
  @ApiPropertyOptional({ enum: OfficeTypeDTO })
  @IsOptional()
  @IsEnum(OfficeTypeDTO)
  type?: OfficeTypeDTO;
  ...
  @ApiPropertyOptional({
    description: 'Размер страницы при чтении из API CDEK',
  })
  @IsOptional()
  @IsInt()
  @Min(1)
...
export class ListFromDbQueryDto {
  ...
  @IsOptional()
  @IsBooleanString()
  have_fast_payment_system?: string;
  @ApiPropertyOptional() @IsOptional() @IsBooleanString() allowed_cod?: string;
  @ApiPropertyOptional() @IsOptional() @IsBooleanString() fulfillment?: string;
  ...
  @ApiPropertyOptional({ description: 'Центр: широта' })
  @IsOptional()
  @IsNumber()
  center_lat?: number;
  @ApiPropertyOptional({ description: 'Центр: долгота' })
  @IsOptional()
  @IsNumber()
  center_lon?: number;
  ...
  @ApiPropertyOptional({
    enum: ['city_code', 'type', 'code', 'distance'] as const,
  })
  @IsOptional()
  @IsString()
  sort_by?: 'city_code' | 'type' | 'code' | 'distance';
